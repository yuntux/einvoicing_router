...
`settings.superpdp_client_mode` — le point d'extension prévu au lot 2."""

from sqlalchemy.orm import Session

from app.afnor.client.adapter import afnor_client_adapter
from app.afnor.client.base import SuperPDPClientProtocol
from app.afnor.client.fake import FakeSuperPDPClient
from app.config import settings
from app.models.referential import Company


def resolve_client_for_company(db: Session, company: Company) -> SuperPDPClientProtocol:
